---
name: wagtail-daisie
description: Work on the wagtail-daisIE Django/Wagtail package. Use when editing blocks, design primitives, menus, themes, icons, the demo site, or its tests and docs in this repository.
license: MIT
---
...
`demo/` — especially block/design changes, menu/theme models, icons, the demo
...
`demo/fixtures/content.json` + media, then seeds themes/menus. Keep it
idempotent. StreamField values use `{"type": "value"}` dicts with chooser IDs,
not model instances.
